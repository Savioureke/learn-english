...
import { BookOpen, User, LogOut, Video, Menu, X, Sparkles } from 'lucide-react';
            ...
            {loggedInUser ? (
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="flex items-center gap-2 bg-gradient-to-r from-accent to-orange-500 hover:from-accent-hover hover:to-orange-600 text-white font-heading font-semibold text-sm px-4 py-2.5 rounded-full shadow-md hover:shadow-lg transition-all animate-pulse"
                >
                  <Video className="w-4 h-4" />
                  <span>Student Video Portal</span>
                ...
                <div className="flex items-center gap-2 bg-slate-100 px-3 py-1.5 rounded-full border border-gray-200">
                  ...
                  <span className="font-heading font-medium text-sm text-navy max-w-[120px] truncate">
              ...
              {loggedInUser ? (
                <>
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-accent text-white font-heading font-semibold py-3 rounded-full shadow-md"
                  >
                    <Video className="w-5 h-5" />
                    <span>Watch English Video Tutorials</span>
                  </button>
                  <button
                    onClick={() => {
                      setMobileMenuOpen(false);
